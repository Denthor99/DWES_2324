...
class clientesModel extends Model
{
    ...
    /**
     * Método clienteExistente($dni)
     * Método que comprueba en la base de datos si existen ya un cliente.
     * Usaremos el dni como campo de  comprobación, por lo que se pasará dicho parámetro como argumento.
     */
    public function clienteExistente($dni){
        try {
            ...
            // Vinculamos la variable
            $pdostmt->bindParam(':dni',$dni, PDO::PARAM_STR_CHAR,9);
