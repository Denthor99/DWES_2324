...
class pdfClientes extends FPDF
{
    ...
    function HeaderListado()
    {
        ...
        $this->Cell(25, 8, iconv('UTF-8','ISO-8859-1', 'Telefono'), 'B', 0, 'C', true);
        $this->Cell(40, 8, iconv('UTF-8','ISO-8859-1', 'Email'), 'B', 0, 'C', true);
        $this->Cell(20, 8, iconv('UTF-8','ISO-8859-1', 'Dni'), 'B', 0, 'C', true);
        $this->Cell(35, 8, iconv('UTF-8','ISO-8859-1', 'Ciudad'), 'B', 1, 'C', true);
    ...
    function Contenido($clientes)
    {
        ...
        foreach ($clientes as $cliente) {
            ...
            $this->Cell(10, 9, iconv('UTF-8','ISO-8859-1', $cliente->id), 'B', 0, 'R', true);
            $this->Cell(60, 9, iconv('UTF-8','ISO-8859-1', $cliente->cliente), 'B', 0, 'C', true);
            $this->Cell(25, 9, iconv('UTF-8','ISO-8859-1', $cliente->telefono), 'B', 0, 'C', true);
            $this->Cell(40, 9, iconv('UTF-8','ISO-8859-1', $cliente->email), 'B', 0, 'C', true);
            $this->Cell(20, 9, iconv('UTF-8','ISO-8859-1', $cliente->dni), 'B', 0, 'C', true);
            $this->Cell(35, 9, iconv('UTF-8','ISO-8859-1', $cliente->ciudad), 'B', 1, 'C', true);
        }
    }
}