                ...
                <?php foreach ($this->cuentas as $cuenta) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= URL ?>cuentas/mostrar/<?= $cuenta->id ?>" title="Mostrar" Class="btn btn-success
                                            <?= (!in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['show'])) ?
                                                'disabled' : null ?>"> <i class="bi bi-eye"></i> </a>
                            <a href="<?= URL ?>cuentas/mostrarMovimientos/<?= $cuenta->id ?>" title="Mostrar Movimientos" Class="btn btn-warning
                                            <?= (!in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['showMovs'])) ?
                                                'disabled' : null ?>"> <i class="bi bi-graph-up"></i> </a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
