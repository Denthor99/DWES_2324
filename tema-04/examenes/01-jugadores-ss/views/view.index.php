...
<body>
    ...
    <div class="container">
        ...
        <!-- Notificacion -->
        <?php include 'partials/partial.notify.php';?>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php foreach ($jugadores->getTabla() as $indice => $jugador): ?>
                        <tr>
                            ...
                            <td><?= implode(', ', tablaJugadores::listaPosiciones($jugador->getPosiciones(), $posiciones)) ?></td>
                ...
                <tfoot>
                    <tr><td colspan="8">Nº Registros <?= count($jugadores->getTabla())?> </td></tr>
                </tfoot>
            </table>
        </div>
    </div>
